...
\begin{figure}[t]
    \centering 
    \includegraphics[width=\linewidth]{data/nlinks_used/graph_percent_all2all.eps}
    \caption{}
    \label{fig:jellyfish}
\end{figure}
...
\begin{figure}[t]
    \centering 
    \includegraphics[width=\linewidth]{data/nlinks_used/graph_percent_all2all_r.eps}
    \caption{}
    \label{fig:jellyfish}
\end{figure}
